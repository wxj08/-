...
Page({
  ...
  getDetail(){
    var that = this;
    wx.cloud.database().collection('school_loses').doc(this.data.id).get({
      success(res){
  ...
  delete(){
    ...
    var that = this;
    wx.cloud.database().collection('school_loses').doc(this.data.id).remove({
      success(res){
        console.log(res)
  ...
  pirzeAction(event){
    ...
    if(app.globalData.userInfo == null){
      ...
      var that = this;
      wx.cloud.database().collection('school_loses').doc(that.data.id).get({
        success(res){
          ...
          if(tag){
            ...
            console.log(action)
            wx.cloud.database().collection('school_loses').doc(that.data.id).update({
              data: {
